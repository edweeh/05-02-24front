...
const SaveData = () => {
  ...
  axios.post( baseUrl+"/pet/tnew", petData)
    .then((response) => {
      alert("Record Saved");
    })
    ...
    <div>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between' }}>
          <button type="submit" onClick={() => { SaveData(); navigatetoview(); }} style={{ backgroundColor: '#4caf50', color: 'white', padding: '10px', border: 'none', cursor: 'pointer' }}>
            ADD 
          </button>
